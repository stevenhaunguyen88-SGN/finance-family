...
// ─── Notifications ───────────────────────────────────────────
//
// In-app alerts generated by the system (budget overspend, savings
// milestones, recurring tx processing, etc.).
export const notifications = sqliteTable("notifications", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  familyId: integer("family_id").notNull(),
  type: text("type", {
    enum: ["budget_warning", "budget_exceeded", "savings_milestone", "savings_completed", "recurring_processed"],
  }).notNull(),
